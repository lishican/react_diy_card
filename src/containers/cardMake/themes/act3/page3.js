...
class Page3 extends BaseComponent {
  ...
  render() {
    return (
      <div className="swiper-slide page_container template3_page3_theme">
        <div className="page">
...
{/* 
          ...
          <Edit
            ...
            className="pic obj17 ani"
            swiperAnimateEffect="fadeInDown"
            swiperAnimateDuration="1s"
