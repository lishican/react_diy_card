    ...
    return (
      <div className="swiper-slide page_container template1_page4_theme">
        <div className="page">
          ...
          <div className="pic obj12 ani" swiper-animate-effect="fadeInUp" swiper-animate-duration=".5s" swiper-animate-delay="3.6s">朋友是读不完的情，写不完的意</div>
          <div className="pic obj13 ani" swiper-animate-effect="fadeInUp" swiper-animate-duration=".5s" swiper-animate-delay="3.7s">是一本看不倦的书，听也听不厌的歌</div>
          <div className="pic obj14 ani" swiper-animate-effect="fadeInUp" swiper-animate-duration=".5s" swiper-animate-delay="3.8s">你和我的情谊</div>
          <div className="pic obj15 ani" swiper-animate-effect="fadeInUp" swiper-animate-duration=".5s" swiper-animate-delay="3.9s">珍藏在梦里，存留在心里</div>
        </div>
      </div>
    );
  }
